            ...
            <div class="card bg-white">
                <div class="card-body">
                    <form action="{{route('tweets.store')}}" method="post">
                        @csrf
            <textarea name="content" class="textarea textarea-bordered w-full" placeholder="apa yang kamu fikirkan?" rows="3"></textarea>
    ...
    <div class="card my-4 bg-white">
        <div class="card-body">
            ...
            <div class="text-end">
                ...
                <span class="teks-sm">{{ $tweet->created_at->diffForHumans() }}</span>
            </div>
        </div>
    </div>
        @endforeach
